...
: ${AMENT_CURRENT_PREFIX:="/home/ayi/unitree_go2_ws/install/go2_slam"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_slam/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_slam/environment/path.sh"
